...
public class MoviesResponse implements Serializable, Parcelable
{
    ...
    public final static Parcelable.Creator<MoviesResponse> CREATOR = new Creator<MoviesResponse>() {
        ...
        public MoviesResponse[] newArray(int size) {
            ...
            ;
    private final static long serialVersionUID = 6855350902145534741L;

    protected MoviesResponse(Parcel in) {
        this.page = ((Integer) in.readValue((Integer.class.getClassLoader())));
        this.totalResults = ((Integer) in.readValue((Integer.class.getClassLoader())));
        this.totalPages = ((Integer) in.readValue((Integer.class.getClassLoader())));
        in.readList(this.results, (com.avivamiriammandel.watchme.model.Movie.class.getClassLoader()));
    }
